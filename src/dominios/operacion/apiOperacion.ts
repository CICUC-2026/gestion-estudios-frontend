...
export const crearTarea = (datos: { titulo: string; prioridad: string; vence_en?: string; paciente_id?: string }) => solicitarApi<Tarea>('/tareas', { method: 'POST', body: JSON.stringify(datos) }, token())
